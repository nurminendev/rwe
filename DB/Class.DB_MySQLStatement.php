 ...
 * @sa DB_MySQL
 */
class DB_MySQLStatement extends DB_SQLStatement
{
    /*! @publicsection */
    /* ====================================================================== */
     ...
     * @sa DB_MySQL::prepare
     */
    function DB_MySQLStatement(&$dbmgr, $query)
    {
    ...
    /** 
     * Fetch the next row from this statement (DB_MySQLStatement::execute must
     * be called first!).
     * 
     ...
     * (DB_MySQLStatement::execute must be called first!).
     * 
     * @remarks Actually just a wrapper around PHP's
     ...
     * rows (ie. if DB_MySQLStatement::fetchRow or
     * DB_MySQLStatement::fetchAssoc has already been called to fetch all rows)
     * or if this statement doesn't have a valid result resource (ie. it hasn't
     * been executed yet).
     */
