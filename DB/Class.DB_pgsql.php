...
require_once(RWE_DIR . 'DB' . DIRECTORY_SEPARATOR . 'Class.DB_pgsqlstmt.php');
 ...
 *
 * @sa DB_pgsqlstmt, DB_pgsql::prepare
 */
class DB_pgsql extends DB_common
{
    ...
    /** 
     * Construct a new DB_pgsql instance.
     * 
     ...
     * doing.
     */
    function DB_pgsql($dsninfo, $persistent = false)
    {
     ...
     * DB_pgsqlstmt for the query is returned. Otherwise false is returned
    ...
    function &prepare($query)
    {
        ...
        $stmt = &new DB_pgsqlstmt($this, $query);
        return $stmt;
    }
